...
data1 = np.genfromtxt('OCR5_1010.csv',delimiter=',',skip_header=1)
...
figure_2 = plt.figure(2, figsize=(8, 6), dpi=200, facecolor='w', edgecolor='k')
...
ax_1.tick_params(axis='x', bottom='on', top='off')  # show x ticks for top and bottom
...
curve_0 = ax_1.plot(axes_Measure, dose_Measure,'x', label='Measure data') #Measure dose 1D, 'k-' is black solid line
curve_1 = ax_1.plot(axes_GBD, dose_GBD,'bo', markersize=3, label='GBD data') #GBD dose 1D, 'b--' is blue dashed line, 'bo' means blue o marker
